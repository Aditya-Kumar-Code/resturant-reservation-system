          ...
          <div className="flex flex-col md:gap-10 gap-[70px] items-center justify-start max-w-[1240px] mb-5 mx-auto w-full">
            <header className="flex items-center justify-center w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-center w-full">
                ...
                <Button className="bg-red-400 cursor-pointer font-semibold sm:hidden leading-[normal] min-w-[112px] md:ml-[0] ml-[25px] py-3.5 rounded-[16px] text-center text-sm text-white-A700">
                  Log in
                </Button>
              </div>
            </header>
        ...
        <div className="flex flex-col font-opensans gap-[50px] items-center justify-start mt-[120px] pt-4 md:px-5 w-[55%] md:w-full">
          ...
          <div className="h-[394px] relative w-full">
            <PagerIndicator
              ...
              count={3}
              activeCss="inline-block cursor-pointer rounded-[50%] h-2.5 bg-red-400 w-2.5 relative mx-[5.00px]"
            ...
            />
            <Button
              className="absolute bg-white-A700 cursor-pointer flex h-[60px] inset-y-[0] items-center justify-center my-auto p-[18px] right-[0] rounded-[50%] shadow-bs5 w-[60px]"
            ...
            <Button
              className="absolute bg-white-A700 cursor-pointer flex h-[60px] inset-y-[0] items-center justify-center left-[0] my-auto p-[18px] rotate-[180deg] rounded-[50%] shadow-bs6 w-[60px]"
